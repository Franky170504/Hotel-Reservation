...
class DataProcessor:
    ...
    def preprocess_data(self, df):
        try:
            ...
            skew_threshold = self.config["data_processing"]["skewnwess_threshold"]
            ...
            raise CustomException("Error while preprocesssing data", e)
    ...
    def balanced_data(self, df):
        try:
            ...
            logger.info("Data balanced done")
            return balanced_df
    ...
    def select_features(self, df):
        try:
            ...
            num_of_feature_to_select = self.config["data_processing"]["no_of_features"]
            top_10_features = top_feature_importance_df["feature"].head(num_of_feature_to_select).values
    ...
    def save_data(self, df, file_path):
        try:
            ...
            raise CustomException("Error while data saving", e)
    ...
    def process(self):
        try:
            ...
            raise CustomException("Error while data preprocesssing pipeline", e)
